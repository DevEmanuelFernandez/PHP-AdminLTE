                  ...
                  <form id="matter" action="matter.php" method="post" name="matter-form">
                    <div class="row">
                      <div class="form-group col-md-6 ">
                        ...
                        <input type="text" name="materia_nombre" class="form-control" id="matterName" placeholder="Ingrese el nombre de la materia">
                      </div>
                      <div class="form-group col-md-6 ">
                        <label for="matterName">Horas catedra</label>
                        <input type="text" name="horas" class="form-control" id="matterName" placeholder="Ingrese las horas catedra">
                      </div>
                      <div class="form-group col-md-6 ">
                        <label for="matterName">Nota final</label>
                        <input type="text" name="nota_final" class="form-control" id="matterName" placeholder="Ingrese las horas catedra">
                      </div>
                      <div class="form-group col-md-6 ">
